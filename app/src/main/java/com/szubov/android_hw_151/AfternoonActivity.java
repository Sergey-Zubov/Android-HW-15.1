    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnStartSynchronisation).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(LOG_TAG, "AfternoonActivity -> btnStartSynchronisation -> onClick");
                Toast.makeText(AfternoonActivity.this, R.string.data_syncing_has_started,
                        Toast.LENGTH_LONG).show();
                Toast.makeText(AfternoonActivity.this,
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Log.d(LOG_TAG, "AfternoonActivity -> btnStartSynchronisation -> " +
