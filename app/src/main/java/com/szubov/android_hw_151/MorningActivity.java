    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnStartSynchronisation).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(LOG_TAG, "MorningActivity -> btnStartSynchronisation -> onClick");
                Toast.makeText(MorningActivity.this, R.string.data_syncing_has_started,
                        Toast.LENGTH_SHORT).show();
                Toast.makeText(MorningActivity.this,
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Log.d(LOG_TAG, "MorningActivity -> btnStartSynchronisation -> " +
